...
<link href="css/css/login2.css" rel="stylesheet" type="text/css" />
</head>
	</head>
	<body>
		<h1>后台登录<sup>V2018二手车专卖场</sup></h1>
<form action="abc/long">
    ...
    <div class="web_qr_login" id="web_qr_login" style="display: block; height: 235px;">    
			...
			<div class="login_form">
               ...
               <input type="hidden" name="to" value="log"/>
                <div class="uinArea" name="username">
                <label class="input-tips" for="u">帐号：</label>
                <div class="inputOuter" name="username">
                    
                    <input type="text" id="u" name="username" class="inputstyle"/>
                </div>
                </div>
                <div class="pwdArea" name="pass">
               <label class="input-tips" for="p">密码：</label> 
               <div class="inputOuter" name="pass">
